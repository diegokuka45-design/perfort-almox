...
import { formatCurrency, formatNumber, exportToExcel } from '../lib/storage';
import { ArrowDownLeft, Plus, Search, Trash2, Download } from 'lucide-react';
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs text-left">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {filteredEntradas.slice().reverse().map((e, idx) => (
                <tr key={`${e.obraId || 0}-${e.id}-${idx}`} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30">
