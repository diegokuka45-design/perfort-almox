...
import { exportCQConcretagemPDF, exportToExcel, formatNumber } from '../lib/firestoreStorage';
...
export const CQConcretagemView: React.FC<CQConcretagemViewProps> = ({
  ...
  const [setor, setSetor] = useState('Setor 1');
  ...
  const [responsavel, setResponsavel] = useState('Eng. Concretagem');
