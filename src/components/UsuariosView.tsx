...
import { getUsers, saveUsers, getCurrentSession } from '../lib/firestoreStorage';
import { Users as UsersIcon, Plus, Shield, KeyRound, Trash2, Edit } from 'lucide-react';
...
const ALL_PERMISSIONS = [
  ...
  { key: 'assistente-ia', label: 'Assistente IA' },
  { key: 'editar', label: 'Editar Registros' },
  { key: 'excluir', label: 'Excluir Registros' },
  { key: 'exportar', label: 'Exportar Excel/PDF' },
  { key: 'emprestimo-ferramentas', label: 'Empréstimo de Ferramentas' },
  { key: 'epi-fornecimento', label: 'Fornecimento de EPIs' },
  { key: 'material-consumo', label: 'Materiais de Consumo' }
];
